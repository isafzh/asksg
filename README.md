...
AskSG draws from 28 official Singapore government documents across 6 source types, totalling ~784K characters of extracted policy text.
...
| [MAS](https://www.mas.gov.sg) | Macroeconomic Reviews Oct 2024, Apr 2025; Monetary Policy Statements Apr 2024, Oct 2024, Apr 2025 | PDF | Monetary policy statements, GDP and inflation forecasts, labour market, exchange rate policy |
...
| MAS | 5 | 249,894 | 31.8% | Oct 2024 – Apr 2025 (2 half-yearly reviews + 3 MPS statements) |
...
| Layer | Metric | Baseline k=7 | Hybrid+Rerank k=9 | Δ |
|---|---|---|---|---|
...
**Known retrieval gap:** Q22 (*"What was Singapore's GDP growth in 2025?"*) scores hit=0 at all k values. The corpus contains MAS's April 2025 forecast (3.0–5.0%) but not the actual 2025 outcome reported in Budget 2026. This is a corpus boundary issue, not a retrieval failure.
