"""
Experiment: baseline pipeline — dense-only retrieval, no BM25, no reranker.

This is Stage 1 of the AskSG evaluation study.  Results are written to
eval/results/baseline_k<k>.json for comparison with hybrid/reranker runs.

Usage:
    python experiments/baseline.py
    python experiments/baseline.py --k 5
    python experiments/baseline.py --k 7
    python experiments/baseline.py --k 9
"""
